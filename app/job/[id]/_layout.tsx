 ...
 *
 * Accept, decline, proof, self-QC and handoff are pushed as full screens: each
 * is a commitment with fields to fill and consequences to read, and a sheet
 * would crop them and invite a half-filled form to be swiped away. A production
 * update is the opposite — one short, reversible step over a job the shop is
 * already looking at — so it is presented as a sheet, sized to its own content,
 * with the job still visible behind it.
 */
